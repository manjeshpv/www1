...
!function (e) {
  function t(t, o) {
    this.element = t, this.options = e.extend({}, n, o), this._flexslider = e(t).data("flexslider"), this._originalFlexsliderWrapupFunction = this._flexslider.wrapup, this._defaults = n, this._name = i, this.init()
  }

  var i = "flexsliderManualDirectionControls", n = {
  ...
  t.prototype.init = function () {
    ...
    e(this.element).find(this.options.previousElementSelector).bind("touchstart.flexsliderPromo click.flexsliderPromo", {self: this}, function (e) {
      e.stopPropagation(), e.preventDefault(), e.handled || (e.data.self.goToTargetInDirection("prev"), e.handled = !0)
    }), e(this.element).find(this.options.nextElementSelector).bind("click.flexsliderPromo", {self: this}, function (e) {
      e.stopPropagation(), e.preventDefault(), e.handled || (e.data.self.goToTargetInDirection("next"), e.handled = !0)
    })
  }, t.prototype.goToTargetInDirection = function (e) {
    var t = this._flexslider.getTarget(e);
    return this._flexslider.canAdvance(t) && this._flexslider.flexAnimate(t), !1
  }, t.prototype.addOrRemoveDisabledStateForDirection = function (e, t) {
    var i = this._flexslider.getTarget(e);
    this._flexslider.canAdvance(i) ? t.removeClass(this.options.disabledStateClassName) : t.addClass(this.options.disabledStateClassName)
  }, t.prototype.onAnimationEnd = function (t) {
    var i = e(this.element).find(this.options.nextElementSelector), n = e(this.element).find(this.options.previousElementSelector);
    this.addOrRemoveDisabledStateForDirection("next", i), this.addOrRemoveDisabledStateForDirection("prev", n), this._originalFlexsliderWrapupFunction(t)
  }, e.fn[i] = function (n) {
